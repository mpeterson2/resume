...
\begin{document}
  ...
  \begin{tabularx}{\linewidth}{r|X}
    ...
    \work{Software Engineer}{Blippy}{August}{Oct}{
      Worked on a small team building a GIF keyboard and organization app for iOS; Used Xcode, writing Objective-C and Swift, to improve and add features to the app; Used Android Studio to start an Android version of the app.
    }
