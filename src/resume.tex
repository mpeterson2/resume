...
\begin{document}
  ...
  \section{Languages and Tools}
    \begin{itemize}
      ...
      \item Have experience with the Spring Framework, the MEAN stack, JQuery, CanJs, and more.
    ...
    \section{Projects - More at \href{http://mpeterson2.github.io}{mpeterson2.github.io}}
      ...
      \project{java-httpserver}{https://github.com/storytellersoftware/java-httpserver}{
        An HTTP Server written in Java. Our goal was to give developers an easy to use API to create a RESTful web server using Java.
      }
